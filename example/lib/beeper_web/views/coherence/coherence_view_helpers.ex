defmodule BeeperWeb.Coherence.ViewHelpers do
  @moduledoc """
  ...
  For example, to generate links in your layout template use:
      BeeperWeb.Coherence.ViewHelps.coherence_links/3
  ...
  @seperator {:safe, "&nbsp; | &nbsp;"}
  @helpers BeeperWeb.Router.Helpers
  ...
  * :register - customize the register link text (#{@register_link_text})
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BeeperWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BeeperWeb.Gettext, "errors", msg, opts)
    end
  end
